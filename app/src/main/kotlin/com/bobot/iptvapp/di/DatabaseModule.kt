 ...
 *
 * ## Migrations
 * Version 4 — see [IptvDatabase] KDoc for the full migration policy.
 ...
 * `accountKey` (Task 3 carry-forward), recreating them empty;
 * [DatabaseMigrations.MIGRATION_3_4] adds the `catalog_sync` freshness markers. Never call
